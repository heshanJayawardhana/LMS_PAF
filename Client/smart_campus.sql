...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `bookings_ibfk_2` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (2,'ADMIN'),(3,'TECHNICIAN'),(1,'USER');
...
CREATE TABLE `tickets` (
  ...
  CONSTRAINT `tickets_ibfk_2` FOREIGN KEY (`resource_id`) REFERENCES `resources` (`id`),
...
-- Dump completed on 2026-03-28 14:55:30
